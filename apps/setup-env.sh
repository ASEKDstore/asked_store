...
# Скрипт для создания .env файлов с токеном бота

BOT_TOKEN="8502780617:AAGir8NDDJuUqm1GTXiXpcH1tQUhJj2qT3M"

echo "Создание .env файлов с токеном бота..."
...
echo "✅ Создан apps/bot/.env"
echo ""
echo "⚠️  ВАЖНО: Обновите DATABASE_URL в apps/backend/.env на ваш реальный URL базы данных!"
